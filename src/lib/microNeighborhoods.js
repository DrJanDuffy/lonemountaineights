// Lone Mountain Heights Micro-Neighborhoods & Subdivisions
// Hyper-local SEO data for each specific area within Lone Mountain Heights
...
export const microNeighborhoods = {
  ...
  subdivisions: [
    ...
    },
    {
      id: 'mountain-crest',
      name: 'Mountain Crest',
      description: 'Hillside community with panoramic views and custom homes',
      avgPrice: 1100000,
      priceRange: { min: 900000, max: 1500000 },
      homeStyles: ['Custom', 'Two Story', 'Contemporary'],
      lotSizes: ['0.3-0.6 acres'],
      yearBuilt: '2010-2023',
      hoa: true,
      hoaFee: 200,
    ...
    },
    {
      ...
      name: 'Canyon Gate Country Club Area',
      description: 'Golf course adjacent properties with premium amenities',
      avgPrice: 1200000,
      priceRange: { min: 950000, max: 1800000 },
      homeStyles: ['Custom', 'Two Story', 'Mediterranean'],
      lotSizes: ['0.3-0.7 acres'],
      yearBuilt: '2005-2022',
      hoa: true,
      hoaFee: 250,
    ...
    },
    {
      ...
      homeStyles: ['Two Story', 'Single Story', 'Modern'],
      lotSizes: ['0.18-0.3 acres'],
      yearBuilt: '2015-2024',
      hoa: true,
      hoaFee: 100,
  ...
  streetClusters: [
    {
      id: 'lone-mountain-road-corridor',
    ...
    },
    {
      ...
      name: 'Desert Foothills Drive Area',
      description: 'Established residential area with mature landscaping',
      avgPrice: 780000,
    ...
    },
    {
      ...
      name: 'Mountain Vista Sections',
      description: 'Premium view lots with mountain and city views',
      avgPrice: 950000,
    ...
    },
    {
      ...
      name: 'Tule Springs Road Neighborhoods',
    ...
    },
    {
      ...
      name: 'Grand Montecito Parkway Area',
  ...
  geographicPockets: [
    ...
    },
    {
      ...
      name: 'Golf Course Adjacent Properties',
      description: 'Homes adjacent to golf courses',
...
// SEO keyword generation for each micro-neighborhood
export function generateMicroNeighborhoodKeywords(subdivision) {
  const baseKeywords = [
    `${subdivision.name} homes for sale`,
